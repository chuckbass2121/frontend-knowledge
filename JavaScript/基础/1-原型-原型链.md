...
![构造函数和实例原型的关系图](https://github.com/chuckbass2121/frontend-knowledge/raw/master/Images/prototype1.png)

原型对象的constructor属性，指向构造函数
![实例原型与构造函数的关系图](https://github.com/chuckbass2121/frontend-knowledge/raw/master/Images/prototype3.png)
